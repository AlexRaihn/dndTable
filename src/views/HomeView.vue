    ...
    <nav class="bg-white shadow dark:bg-gray-900">
        <div class="container px-6 py-4 mx-auto">
            <div class="lg:flex lg:items-center lg:justify-between">
                ...
                <div :class="[isOpen ? 'translate-x-0 opacity-100 ' : 'opacity-0 -translate-x-full']" class="absolute inset-x-0 z-20 w-full px-6 py-4 transition-all duration-300 ease-in-out bg-white shadow-md lg:bg-transparent lg:dark:bg-transparent lg:shadow-none dark:bg-gray-900 lg:mt-0 lg:p-0 lg:top-0 lg:relative lg:w-auto lg:opacity-100 lg:translate-x-0">
...
// import MainShutter from '@/components/Public/MainPage/MainShutter/MainShutter.vue'
...
/*
  ...
  function openModal() {
    renderModal(
      ...
      {
        // Слоты для MyComponent
        header: () => h("h1", "Custom Header"),
        footer: () => h("p", "Custom Footer"),
      }
    );
  }
  <\/script>
